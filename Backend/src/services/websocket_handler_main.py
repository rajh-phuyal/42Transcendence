...
# Chat stuff
from chat.utils_ws import process_incoming_seen_message, get_other_user_async, validate_conversation_membership_async
from services.send_ws_msg import send_ws_chat_temporary, send_ws_info_msg, send_ws_badge, send_ws_badge_all, send_ws_chat
...
class WebSocketMessageHandlersMain:
    ...
    async def handle_chat(consumer, user, message):
        ...
        try:
            ...
            await send_ws_info_msg(user.id, e.message)
            return
